...
public class CustomerService {
    ...
    private HashMap<Long, Customer> contacts = new HashMap<>();
    ...
    public synchronized void delete(Customer value) {
        ...
        Customer deleted = contacts.remove( value.getId());
        //Notification.show("DELETED Customer: " + deleted);
        //Notification.show("before: " + before + " to " + contacts.size());
